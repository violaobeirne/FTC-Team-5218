...
@TeleOp(name = "IMU Light Test")
public class IMULightTest extends LinearOpMode {
    BNO055IMU imu;
    ...
    protected void zeroLinearAccel() {
    ...
    void composeTelemetry() {
        ...
        telemetry.addLine()
                .addData("linearaccel", new Func<String>() {
                    @Override public String value(){
                        return linearaccel.toString();

                    }
                });

        telemetry.addLine()
                .addData("overallaccel", new Func<String>() {
                    @Override public String value(){
                        return overallaccel.toString();
                    }
                });
    }
