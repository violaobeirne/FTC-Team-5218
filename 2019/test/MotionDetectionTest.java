 ...
 */
@TeleOp(name = "Motion Detection Test")
@Disabled
public class MotionDetectionTest extends Robot {
    ...
    public void start() {
        ...
        addTask(driveTask);
        this.addTask(new MotionDetectionTask(this, imu) {
            public void handleEvent (RobotEvent e) {
                MotionDetectionEvent event = (MotionDetectionEvent) e;
                if (event.type == EventType.MOVING) {
                    RobotLog.i("163: Robot moving.");
                    blinkin.setPattern(VivaldiCalibration.TELEOP_PATTERN);
                } else if (event.type == EventType.STOPPED) {
