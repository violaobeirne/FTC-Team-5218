...
public class MarkerDropoff2 {
    ...
    public MarkerDropoff2() {
        ...
        paths[MarkerDropoff2.DropMarker.TRUE.ordinal()][GoldMineralPosition.LEFT.ordinal()].addSegment(DeadReckonPath.SegmentType.STRAIGHT, 5, 0.5);
        paths[MarkerDropoff2.DropMarker.TRUE.ordinal()][GoldMineralPosition.LEFT.ordinal()].addSegment(DeadReckonPath.SegmentType.TURN, 90, 0.5);
        paths[MarkerDropoff2.DropMarker.TRUE.ordinal()][GoldMineralPosition.LEFT.ordinal()].addSegment(DeadReckonPath.SegmentType.STRAIGHT, 18, 0.5);
        paths[MarkerDropoff2.DropMarker.TRUE.ordinal()][GoldMineralPosition.LEFT.ordinal()].addSegment(DeadReckonPath.SegmentType.TURN, 60, -0.5);
        paths[MarkerDropoff2.DropMarker.TRUE.ordinal()][GoldMineralPosition.LEFT.ordinal()].addSegment(DeadReckonPath.SegmentType.STRAIGHT, 30, 0.5);
        paths[MarkerDropoff2.DropMarker.TRUE.ordinal()][GoldMineralPosition.LEFT.ordinal()].addSegment(DeadReckonPath.SegmentType.TURN, 60, 0.3);
        paths[MarkerDropoff2.DropMarker.TRUE.ordinal()][GoldMineralPosition.LEFT.ordinal()].addSegment(DeadReckonPath.SegmentType.STRAIGHT, 30, 0.5);

        paths[MarkerDropoff2.DropMarker.TRUE.ordinal()][GoldMineralPosition.CENTER.ordinal()] = new DeadReckonPath();
        paths[MarkerDropoff2.DropMarker.TRUE.ordinal()][GoldMineralPosition.CENTER.ordinal()].addSegment(DeadReckonPath.SegmentType.STRAIGHT, 5, 0.5);
        paths[MarkerDropoff2.DropMarker.TRUE.ordinal()][GoldMineralPosition.CENTER.ordinal()].addSegment(DeadReckonPath.SegmentType.TURN, 90, 0.4);
        paths[MarkerDropoff2.DropMarker.TRUE.ordinal()][GoldMineralPosition.CENTER.ordinal()].addSegment(DeadReckonPath.SegmentType.STRAIGHT, 40, 0.5);

        paths[MarkerDropoff2.DropMarker.TRUE.ordinal()][GoldMineralPosition.RIGHT.ordinal()] = new DeadReckonPath();
        paths[MarkerDropoff2.DropMarker.TRUE.ordinal()][GoldMineralPosition.RIGHT.ordinal()].addSegment(DeadReckonPath.SegmentType.STRAIGHT, 5, 0.5);
        paths[MarkerDropoff2.DropMarker.TRUE.ordinal()][GoldMineralPosition.RIGHT.ordinal()].addSegment(DeadReckonPath.SegmentType.TURN, 90, 0.5);
        paths[MarkerDropoff2.DropMarker.TRUE.ordinal()][GoldMineralPosition.RIGHT.ordinal()].addSegment(DeadReckonPath.SegmentType.STRAIGHT, 40, 0.5);
        paths[MarkerDropoff2.DropMarker.TRUE.ordinal()][GoldMineralPosition.RIGHT.ordinal()].addSegment(DeadReckonPath.SegmentType.STRAIGHT, 40, 0.5);

        paths[MarkerDropoff2.DropMarker.FALSE.ordinal()][GoldMineralPosition.LEFT.ordinal()] = new DeadReckonPath();
        paths[MarkerDropoff2.DropMarker.FALSE.ordinal()][GoldMineralPosition.LEFT.ordinal()].addSegment(DeadReckonPath.SegmentType.STRAIGHT, 5, 0.5);
        ...
        paths[MarkerDropoff2.DropMarker.FALSE.ordinal()][GoldMineralPosition.LEFT.ordinal()].addSegment(DeadReckonPath.SegmentType.STRAIGHT, 25, 0.5);
        ...
        paths[MarkerDropoff2.DropMarker.FALSE.ordinal()][GoldMineralPosition.LEFT.ordinal()].addSegment(DeadReckonPath.SegmentType.STRAIGHT, 30, 0.5);
