...
@Autonomous(name = "(S) Vortex (G) Particle Cap Ball", group = "AutoTest")
public class MochaParticleCapBallVAutonomous extends Robot {
    ...
    public void init()
    {
        ...
        pushCapDeadReckon = new FourWheelDirectDriveDeadReckon
                (this, TICKS_PER_INCH, TICKS_PER_DEGREE, frontRight, backRight, frontLeft, backLeft);
        pushCapDeadReckon.addSegment(DeadReckon.SegmentType.STRAIGHT, 50, -0.75);
