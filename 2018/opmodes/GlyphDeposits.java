...
public class GlyphDeposits {
    ...
    public GlyphDeposits()
    {
        ...
        paths[StartingPosition.R1.ordinal()][TargetColumn.LEFT.ordinal()].addSegment(DeadReckonPath.SegmentType.STRAIGHT, 51, 0.5);
        ...
        paths[StartingPosition.R1.ordinal()][TargetColumn.MIDDLE.ordinal()].addSegment(DeadReckonPath.SegmentType.STRAIGHT, 43, 0.5);
        ...
        paths[StartingPosition.R1.ordinal()][TargetColumn.RIGHT.ordinal()].addSegment(DeadReckonPath.SegmentType.STRAIGHT, 38, 0.5);
        paths[StartingPosition.R1.ordinal()][TargetColumn.RIGHT.ordinal()].addSegment(DeadReckonPath.SegmentType.TURN, 76, 0.3);
        ...
        paths[StartingPosition.B1.ordinal()][TargetColumn.LEFT.ordinal()].addSegment(DeadReckonPath.SegmentType.STRAIGHT, 38, -0.5);
        paths[StartingPosition.B1.ordinal()][TargetColumn.LEFT.ordinal()].addSegment(DeadReckonPath.SegmentType.TURN, 76, 0.3);
        ...
        paths[StartingPosition.B1.ordinal()][TargetColumn.MIDDLE.ordinal()].addSegment(DeadReckonPath.SegmentType.STRAIGHT, 43, -0.5);
        ...
        paths[StartingPosition.B1.ordinal()][TargetColumn.RIGHT.ordinal()].addSegment(DeadReckonPath.SegmentType.STRAIGHT, 51, -0.5);
