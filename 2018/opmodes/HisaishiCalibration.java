...
public class HisaishiCalibration {
    ...
    public static final double GLYPH_OPEN_LEFT_POSITION = 251.0/256.0;
    ...
    // jewel
    public static final double JEWEL_Y_AXIS_DEPLOYED = 37.0/256.0;
    public static final double JEWEL_Y_AXIS_STOWED = 190.0/256.0;
    ...
    public static final double RELIC_GRABBER_CLOSE_POSITION = 110.0/256.0;
